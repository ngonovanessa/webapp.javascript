...
6. Within the body of your attackHandler function:   
   ...
   b. Subtract the monsterDamage from the currentMosterHealth and s and store the result in the currentMonsterHealth variable.
   c. Call the function dealPlayerDamage (located in vendor.js file) and pass monsterAttackValue as a parameter store its return value 
